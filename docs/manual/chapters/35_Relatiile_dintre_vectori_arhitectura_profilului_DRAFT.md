...
La sfârșitul capitolului precedent aveam patru imagini vectoriale.
...
Fiecare poate fi citită în interiorul ei: știm câte tendințe apar în prim-plan, cum sunt distribuite între cei doi factori și ce sens vectorial general rezultă.

Tentația următoare este firească. Scriem patru interpretări, una sub alta, și le numim „profil”.

Dar tocmai aici apare o eroare mai rafinată.
...
Fiecare propoziție poate fi, separat, adevărată în sens general.

Și totuși întregul poate fi fals.

Problema nu este piesa.

Problema este relația dintre piese.

Un `Vektorbild` nu încetează să fie ceea ce este atunci când intră în profil. Dar nu mai poate fi interpretat ca și cum celelalte trei imagini nu ar exista.

## `Korrelative Deutung`

Regula prin care Szondi răspunde acestei dificultăți este **`korrelative Deutung`** — interpretarea corelativă.

El formulează cerința în două registre simultan:
...
Factorii se află în relații unii cu alții. Vectorii se află în relații unii cu alții. O reacție nu poate fi desprinsă din ceea ce Szondi numește `komplexes Triebganzes` și tratată ca o unitate autosuficientă.

În propriul său model, Szondi consideră aceste relații biologic condiționate. Această explicație aparține gentheoriei sale istorice. Pentru metoda de lectură, consecința este însă foarte precisă:

**un vector nu își pierde sensul când intră în profil; își pierde autonomia.**

## Patru domenii, un singur profil

Cei patru vectori delimitează patru domenii diferite.

S pune în joc sexualitatea.

P, afectul și problematica etic-morală.

Sch, funcțiile pulsionale ale Eului.
...
Szondi dă chiar vectorul S ca exemplu al acestei reguli.
...
Sch nu este comentariul lui S.

S nu este comentariul lui Sch.

Ele se precizează reciproc în profil.
...
Patru vectori ar permite șase perechi formale:

S–P, S–Sch, S–C, P–Sch, P–C, Sch–C.

Ar fi tentant să construim o metodă în care fiecare profil este citit obligatoriu prin toate cele șase perechi, în aceeași ordine.

Corpusul nu ne dă o asemenea matrice universală.

În *Triebpathologie*, Szondi admite chiar că interpretarea liberă poate porni de la vectori diferiți sau de la reacții care par conducătoare. Condiția este alta: ceea ce a fost scos în față trebuie apoi verificat **în corelație cu toate celelalte reacții**.

Așadar, libertatea punctului de pornire nu înseamnă libertatea de a ignora restul profilului.

Putem începe din locuri diferite.
...
Înseamnă că fiecare propoziție trebuie să poată supraviețui întâlnirii cu celelalte.
...
Nu ne spune încă ce opoziție îl organizează.

Aici începe problema lui **`Rand` și `Mitte`**.