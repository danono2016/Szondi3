...
Un profil Szondi pare scris într-un alfabet foarte mic.
...
**în ce direcție a fost ales?**

Termenii lui sunt `Quantität` și `Tendenzrichtung`.

O reacție factorială este întâlnirea lor.

## Două coordonate într-un singur semn

Din cele șase fotografii ale aceluiași factor, persoana poate alege puține, un număr mediu sau foarte multe. Aceasta este dimensiunea cantitativă a reacției.

Dar fotografiile alese sunt totodată distribuite între simpatie și antipatie. De aici rezultă direcția pozitivă, negativă sau ambivalentă.

Szondi formulează diferența fără echivoc: cantitatea indică `Stärke des Bedürfnisses`, forța trebuinței; direcția indică `Stellungnahme des Ichs`, luarea de poziție a Eului față de tendință.

Așadar, două reacții notate pozitiv pot avea aceeași direcție fără să aibă aceeași tensiune. Și două reacții cu o cantitate apropiată pot fi orientate diferit.

Citirea completă începe când nu mai confundăm aceste două axe.

## `Leerreaktion`, `Durchschnittsreaktion`, `Vollreaktion`

După cantitate, Szondi distinge trei forme.

La un capăt se află `Leerreaktion` sau `Nullreaktion`: factorul primește foarte puține alegeri.

La mijloc se află `Durchschnittsreaktion`, reacția medie.

La celălalt capăt se află `Vollreaktion`, reacția plină, în care o mare parte din cantitatea disponibilă a factorului este atrasă în alegere.
...
Reacția este deja citibilă. Încă nu este singură.

## Direcția: `Bejahung`, `Verneinung`, `Bitendenz`

A doua coordonată este direcția.

În reacția pozitivă, Eul alege actual tendința pozitivă a factorului.

În reacția negativă, alege actual tendința negativă.
...
Dintre toate reacțiile, `0` invită cel mai ușor la o concluzie greșită.

Vizual, pare absență.

Doctrinar, spune mai întâi altceva: trebuința respectivă **lipsește actual din prim-plan**.

De ce lipsește este o problemă separată.

În *Lehrbuch*, Szondi dă mai multe posibilități. Trebuința poate să fi ajuns recent la satisfacere sau manifestare. Poate să fi găsit satisfacere pe căi de socializare ori sublimare. Mai rar, reacția nulă poate trimite la o slăbiciune constituțională a factorului.

Același `0` nu decide singur între aceste posibilități.

De aceea Szondi spune că forma concretă a manifestării poate fi stabilită numai prin profilul întreg și, mai ales, prin serie.

`0` nu este nimicul trebuinței. Este o stare actuală a apariției ei în prim-plan.
...
O trebuință puternic încărcată poate ajunge la o tensiune atât de mare încât cantitatea se împarte între cele două direcții; ambivalența poate deveni astfel o fază premergătoare descărcării, iar după descărcare factorul poate apărea `0` în prim-plan.

Este una dintre imaginile cele mai vii ale reacției factoriale: ceea ce pare gol poate fi momentul care urmează unei încărcări foarte mari.
...
Până aici am desfăcut reacția pentru a vedea ce conține.

Din clipa în care o punem lângă reacția factorului partener, nu mai avem două semne independente.

Avem începutul unui `Vektorbild`.