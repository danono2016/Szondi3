# SZ_IA_1956_A — FULL-READ CHECKPOINT

**Status:** SOURCE-ORDER BOOK READ COMPLETE; selective P2A extraction in progress  
**Source:** `SZ_IA_1956_A` — `SZONDI_PRIMARY`  
**Book:** L. Szondi, *Ich-Analyse*, erster physischer Teil des 1956 erschienenen zweiten Bandes der *Triebpathologie*  
**Admitted DOCX:** `sources/text/Szondi Ich-Analyse 1.docx`  
**DOCX SHA-256:** `e00c9a0ec985c7c5e3ec0ad5370de50236ed245b2d3b817d63131e1e77eb452b`  
**Visual arbiter:** `sources/originals/Szondi Ich-Analyse 1. Teil.pdf`  
**PDF Git blob witness:** `950834b371fd01f70582257abd74bbcfc5807175`

## Reading scope and EOF

The admitted PDF was read sequentially from its first scan through scan 259, including title/front matter, table of contents, preface, continuous authored body, tables/figures encountered in the reading, and the physical end of the file. The second admitted physical source, `SZ_IA_1956_B`, continues the same work and pagination separately.

**Book-level source-order reading status for this physical source:** `EOF REACHED`.
...
- workflow run: `33074909157`
- artifact: `9647436533` (`p0-canonical-access`)
- digest: `sha256:39e86644849496d465465e6fd57ae8e11d4b1c9417bd07800db4fe1021528639`
- artifact head: `492f16ab07a15a7fa2c5fd8d38063401e9f9f4ac`
...
The canonical OCR recurrently corrupts p/k notation, plus/minus signs, tables and typography. Exact factor signs, `Sch` configurations, table relations, foreign expressions and OCR-damaged terms must be arbitrated locally against the admitted PDF when meaning depends on visual form. Arbitration never silently rewrites `sourceExcerpt`.

## Ambiguities and questions carried forward

- assertion strength is decided passage by passage, preserving `u. E.`, `Annahme`, `Hypothese`, `Tendenz`, probability and similar qualifiers;
- hereditary/genetic/genotropic, sexual, pathodiagnostic and criminological claims require fidelity proportional to consequence;
- differences from `SZ_SA_1948` or `SZ_LEHR_1972` remain relation candidates and are not harmonized source-locally;
- the physical split A/B preserves separate source IDs and doctrine namespaces.

## Current P2A position

`BODY U000001-U000466` is covered as non-doctrinal front matter/table of contents. Curated selective doctrine and exhaustive coverage are complete through **`BODY U001576`**. The next source-order position is **`BODY U001577`**.
