...
Ultimul criteriu al sindromaticii ne-a lăsat în fața unei situații neobișnuite. Unui sindrom patologic ar trebui, spune Szondi, să-i poată corespunde un `Sublimationssyndrom`: aceiași factori, dar cu `polar entgegengesetzten Richtungszeichen` și cu o semnificație clinică opusă.

Dacă aceleași rădăcini pot participa atât la o organizare patologică, cât și la una sublimatorie, atunci întrebarea nu mai poate fi doar: *ce tendință există?*

Trebuie să întrebăm: **ce destin primește această tendință?**

Aici se deschide problema normalității la Szondi.

## Normalitatea nu este absența radicalului

În schema introductivă din `Triebpathologie I`, Szondi descrie `NORMALITÄT` prin trei mișcări: controlul impulsurilor periculoase, acceptarea realității — `Anpassung` — și găsirea unor scopuri și obiecte sociale sau etice pentru tendințele care nu pot fi satisfăcute în forma lor primară — `Sozialisierung und Sublimierung`.

Citită singură, această schemă ar putea sugera o opoziție prea simplă: de o parte pulsiunea periculoasă, de cealaltă omul normal care o ține în frâu. Dar chiar teoria radicalilor obligă la o lectură mai complicată.

Szondi urmărește aceeași funcție pulsională pe mai multe `Erscheinungsebenen`. În tabelele sale, aceeași rădăcină poate apărea în forme infantile, adulte, caracteriale, profesionale, socializate, sublimatorii sau patologice. Nu avem, prin urmare, un set de factori ai bolii și alt set de factori ai sănătății.

Avem aceleași `Radikale`, cu destine diferite.

Aceasta devine explicită în `Triebpathologie II`, chiar înainte de formularea criteriilor sindromului experimental. Szondi observă că unele persoane `hochsozialisiert und sublimiert` pot prezenta în experiment **aceleași `Triebgefahrzonen` ca psihoticii**. El spune, în același loc, că proporțiile pericolelor pulsionale nu sunt suficiente pentru a decide dacă omul este actualmente bolnav sau încă sănătos.
...
Aceasta nu o face însă sublimare.

Adaptarea răspunde mai întâi la întrebarea: **cum se modifică raportul dintre trebuință și realitate?** Ea nu spune încă în ce formă socială, culturală sau spirituală va fi trăită energia acelui conflict.

## Socializarea nu este sublimarea

Tabelele despre `Wandlung der Erscheinungsformen der Triebfaktoren` separă ceea ce într-o lectură grăbită ar putea părea același lucru.
...
El acceptă drept corectă, la nivel conceptual, definiția în care sublimarea schimbă scopul și obiectul unei pulsiuni către o realizare socială sau etică mai înalt valorizată. Dar nu acceptă explicația potrivit căreia aceeași tendință, inițial inacceptabilă, ar fi pur și simplu remodelată într-una „bună”.

În propria lui teorie, polii pe care îi numește social-pozitiv și social-negativ sunt concepuți ca tendințe elementare opuse. Sublimarea nu transformă unul dintre poli în celălalt. Ea schimbă **care pol ocupă prim-planul**.

Termenii sunt `Umdrehung der Triebbühne` și, mai târziu, `Dominanzwechsel`: scena pulsională se întoarce, raportul de dominație se schimbă, o posibilitate care se afla în fundal poate deveni dominantă, iar cea care ocupa scena se retrage.
...
`Ich-Analyse` mută centrul problemei. Sublimarea nu mai este descrisă numai prin alternanța prim-plan/fundal, ci prin felul în care Eul tratează `Triebgefahr`.
...
`Sozialisierung` nu este o sublimare incompletă.
...
Dacă sublimarea descrie un anumit destin al pulsiunii, `Humanisierung` capătă în opera matură un sens mai larg.
...
Patologia nu începe acolo unde apare radicalul.

Ea începe acolo unde destinul lui se organizează într-o formă clinică.
