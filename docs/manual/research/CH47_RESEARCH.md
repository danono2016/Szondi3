...
Cum descrie Szondi „normalitatea” și transformarea pulsională fără să reducă sănătatea la absența tendințelor periculoase și fără să confunde `Anpassung`, `Sozialisierung`, `Sublimierung` și `Humanisierung`?

Capitolul trebuie să lege direct cap. 46 de sindromatica patologică ce începe în cap. 48. El trebuie să arate de ce aceeași rădăcină pulsională poate apărea în destine foarte diferite și de ce o configurație „socializată” sau „sublimată” nu poate fi dedusă mecanic dintr-un singur semn.
