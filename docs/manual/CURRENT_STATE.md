...
Nu expunem cititorului administrarea internă a surselor. Diferențele Szondi / Deri / Mélon se fac vizibile prin atribuire și formulare, nu prin comentarii de redacție.

Formulele metatextuale de guvernanță se folosesc numai când previn o eroare reală sau fixează o frontieră necesară.

Metaforele și parafrazele pedagogice trebuie să păzească frontierele factoriale la fel de strict ca afirmațiile doctrinare.
...
- `C = Kontakttrieb`, construit prin `Verschränkung` a trebuințelor d și m;
