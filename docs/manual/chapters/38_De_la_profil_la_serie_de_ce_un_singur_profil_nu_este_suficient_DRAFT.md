...
Capitolul precedent a dus lectura profilului până la raportul dintre `Vordergrund` și `Hintergrund`.

Am putut construi complementul, am separat VGP, ThKP și EKP și am văzut că o configurație de prim-plan nu epuizează nici măcar câmpul pulsional al momentului.

Dar adâncimea nu este încă timpul.
...
Dacă presupunem că în adâncul persoanei există o configurație care ar trebui să se reproducă identic la fiecare examinare, orice modificare a profilului pare imediat suspectă. Un test repetat ar trebui, după această logică, să dea mereu același rezultat.

Szondi pornește de la altă premisă.

Pentru el, omul poartă mai multe posibilități de existență și de destin. În consecință, faptul că profilele unei serii diferă nu reprezintă, prin el însuși, un defect al observației. Tocmai diferențele pot face vizibile `Wandlungsmöglichkeiten` și `Wandlungsrichtungen` — posibilități și direcții de transformare.

De aceea, într-o serie, întrebarea nu este:

**Care dintre aceste profile este cel adevărat?**
...
În *Triebpathologie I*, Szondi descrie ceea ce devine vizibil atunci când experimentul este repetat. Profilele pot fi așezate unul după altul, iar reacțiile factorilor și vectorilor pot fi urmărite în succesiunea lor. Unele revin. Altele dispar. Tensiuni care într-un profil sunt puternice se pot descărca sau se pot reorganiza în altul. O configurație poate lăsa locul alteia și poate reapărea ulterior.

Cuvântul decisiv este `Nacheinander`: **unul după altul**.

Profilul ne arată o configurație simultană a celor patru vectori. Seria introduce ordinea în care asemenea configurații apar.

Putem formula astfel diferența:

**profilul organizează simultaneitatea; seria adaugă succesiunea.**

Nu este nevoie încă să spunem ce fel de schimbare are loc. Aceasta va deveni problema capitolului următor. Deocamdată este suficient să vedem că, prin repetare, testul dobândește o dimensiune pe care nici cea mai atentă interpretare a unui singur profil nu o poate produce: timpul experimental.
...
## De la ceea ce apare la ceea ce revine
...
**această configurație apare acum.**

Într-o serie putem începe să întrebăm:

**revine?**

Această diferență pare simplă, dar este decisivă. O reacție puternică într-un singur profil și aceeași reacție care reapare în mai multe momente ale seriei nu au același statut temporal. La fel, o configurație care domină la început și apoi dispare nu poate fi tratată pur și simplu ca una care traversează întreaga serie.

Nu stabilim încă regulile constanței. Nu clasificăm încă alternanțele și nu vorbim încă despre faze. Important este numai pragul metodologic: **seria permite să separăm apariția de reapariție.**

## Seria nu este media profilelor

Odată ce avem mai multe profile, apare o tentație firească: să le condensăm într-un profil mediu.

Ar fi însă o pierdere tocmai a informației pentru care am construit seria.
...
Abia după ce știm ce s-a întâmplat în fiecare moment putem întreba cât de des, cât de constant sau în ce ordine s-a întâmplat.
...
**Seria ne arată dacă acea configurație rămâne singură, revine, cedează locul alteia sau reapare după o schimbare. Abia de aici putem vorbi riguros despre constanță, schimbare și fază.**
